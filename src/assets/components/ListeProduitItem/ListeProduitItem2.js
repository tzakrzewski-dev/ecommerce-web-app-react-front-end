...
class ListeProduitItem2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  render() {
    ...
    return (
      ...
      <div className="container-fluid">
        <h2 style={{ "text-align": "center", "text-transform": "uppercase", "margin": "4rem auto 1rem" }}>BONS PLANS</h2>
...
export default connect(mapStateToProps, mapDispatchToProps)(ListeProduitItem2);
